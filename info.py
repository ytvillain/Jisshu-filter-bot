...
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1004447188957"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1004447188957"))
...
GATE_API_URL = environ.get("GATE_API_URL", "")   # e.g. https://your-protection-bot.up.railway.app
GATE_API_KEY = environ.get("GATE_API_KEY", "")   # must match the protection bot's own GATE_API_KEY
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://i.ibb.co/1YD71jN8/x.jpg",
    )
).split()
FORCESUB_IMG = environ.get("FORCESUB_IMG", "https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg")
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split()
PAYPICS = (
    environ.get("PAYPICS", "https://i.ibb.co/1YD71jN8/x.jpg")
).split()
